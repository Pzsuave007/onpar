  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/tournament/:tournamentId/bracket" element={<ProtectedRoute><Bracket /></ProtectedRoute>} />
        <Route path="/tournament/:tournamentId/scorer-assignments" element={<ProtectedRoute><ScorerAssignments /></ProtectedRoute>} />
